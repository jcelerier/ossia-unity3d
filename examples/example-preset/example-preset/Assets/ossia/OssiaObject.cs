...
namespace AssemblyCSharp
{
	...
	public class OssiaObject : MonoBehaviour
	{
		...
		public void Start()
		{
            scene_node = null;
            child_node = null;
            ossia_transform = null;

            var obj = GameObject.Find ("OssiaController");
            if(obj == null) { Debug.Log("OssiaController not found."); return; }


			var comp = obj.GetComponent<OssiaDevices> ();
            if (comp == null) { Debug.Log("OssiaDevices component not found."); return; }
